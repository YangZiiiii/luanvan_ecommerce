class AppContactContentPage extends HTMLElement {
   connectedCallback() {
   this.innerHTML = `
               ...
               <div class="flex-w w-full p-b-42">
                  ...
                  <div class="size-212 p-t-2">
                     ...
                     <p class="stext-115 cl6 size-213 p-t-18">
                        Coza Store Center 8th floor, 379 Hudson St, New York,
                        NY 10018 US
                     </p>
                  </div>
               </div>
   ...
   customElements.define("contact-content-page", AppContactContentPage);